...
public class DisabledDataRequestAdd extends DisabledDataRequest {
    ...
    public DisabledDataRequestAdd(ZipPackage zipPackage) throws FileNotFoundException {
        initRequest(zipPackage);
    }

    private void initRequest(ZipPackage zipPackage) throws FileNotFoundException {
        String requestTemplate = loadTemplate(new File("./src/main/resources/RequestTemplates/DisabledDataRequest/add.xml"));
