...
public class DisabledDataRequestUpdate extends DisabledDataRequest {
    ...
    public DisabledDataRequestUpdate(KOSPackage KOSPackage) throws IOException {
        initRequest(KOSPackage);
    }

    private void initRequest(KOSPackage KOSPackage) throws IOException {
        String requestTemplate = loadResource(new File("./RequestTemplates/DisabledDataRequest/update.xml"));
